...
and pin the immutable Hub revision declared by the successor's loading contract.**Energy-metered, governed inference receipts.** A lightweight, dependency-light
